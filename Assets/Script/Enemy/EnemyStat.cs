...
public class EnemyStat : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        def = source.def;
        atk = source.atk;
        atkSpd = source.atkSpd;
        spd = source.spd;
        knockback = source.knockback;
        atkRange = source.atkRange;
        dmgType = source.dmgType;
        dmgRes = source.dmgRes;
        elemDmg = source.elemDmg;
        elemRes = source.elemRes;
        debuffDuration = source.debuffDuration;
        buffDuration = source.buffDuration;
        healAmount = source.healAmount;
        debuffRes = source.debuffRes;
        addChance = source.addChance;
    }
}
